...
\begin{itemregion} {\lbar{blue}Grants, Awards and Recognitions}
	\service{Class of 1991 Award for Promising Young Faculty in Computer Science and Engineering, IIT Madras, 2019.}
...
\begin{itemregion} {\lbar{blue}Service}
  \service{Organizer, \href{http://www.dagstuhl.de/en/program/calendar/semhp/?semnr=18172}{Dagstuhl Seminar on "Algebraic Effect Handlers go Mainstream"}, Apr 2018.}
	\service{Organizer, \href{https://shonan.nii.ac.jp/seminars/143/}{Shonan Meeting No.143 on Programming Language Support for Data-intensive Applications}, June 2019.}
	\service{Editor, Special Issue of the Journal of Functional Programming (JFP) on the Theory and Practice of Algebraic Effects and Handlers, 2019.}
	\service{Program Committee Chair: ML Workshop 2019.}
  \service{Program Committee member: ICFP 2020, PAPOC@EuroSys 2020, OCaml Workshop 2019, PMLDC@ECOOP 2017, Off-the-beaten track (OBT) 2017, OCaml Workshop 2016, SPLASH-MARC symposium, 2013.}
	\service{External Review Committee: ICFP 2019.}
  \service{Artifact Evaluation Committee member: ICFP 2018, PLDI 2015, PPoPP/CGO 2016.} \vspace{0.5ex}
  \service{Reviewer: PLDI 2020, ESOP 2020, JPDC 2020, LICS 2019, ECOOP 2019, TODS 2019, JFP 2018, POPL 2014, ICFP 2013, ASPLOS 2013, TLDI 2013, Concurrency and Computation:
...
\begin{region} {\lbar{purple}Workshop Publications}{{W}1}{15}
...
\begin{itemregion}{\lbar{red}Teaching/Advising}
  \service{Lecturer:}
	\begin{itemize}
			\service{Programs and Proofs, IIT Madras, Spring '20}
			\service{Paradigms of Programming, IIT Madras, Monsoon '19}
	\end{itemize}
  ...
  \begin{itemize}
    \service{Pratap Singh, Harvard University, count-min sketch in Owl}
		\service{Simon Fowler, University of Edinburgh, \texttt{cmm\_of\_wasm}: An ahead-of-time compiler for WebAssembly, May 2018 -- July 2018.}
		\service{Matevz Polijanc, University of Cambridge, A Reactive Programming model in OCaml, Oct 2017 -- Mar 2018.}
		\service{Charlie Crisp, University of Cambridge, A Blockchain in Pure OCaml, Oct 2017 -- Mar 2018.}
		\service{Henry Mercer, University of Cambridge, Systematic Concurrency Testing for Multicore OCaml, Oct 2017 -- Mar 2018.}
    \service{Nicolas Assouad, ENS Paris, Hardware Support for Composable Lock-free Transactions, Mar 2017 -- Jun 2017.}
    \service{Matt Harrison, University of Cambridge, Secure Decentralized Apps, Sep 2016 -- Mar 2017.}
    \service{Maxime Lesourd, ENS de Lyon, Verified CPS translation of handlers, Sep 2016 -- Mar 2017.}
    \service{Philip Dexter, Binghampton University, Approximate computing for OCaml, May 2016 -- Aug 2016.}
    \service{James Wright, University of Cambridge, Mechanized semantics of Algebraic Effects in OCaml, Sep 2015 -- Mar 2016.}
    \service{Armael Gueneau, ENS de Lyon, Algebraic Effects for js\_of\_ocaml, Sep 2015 -- Mar 2016.}
    \service{Theo Laurent, ENS, Reagents for Multicore OCaml, May 2015 -- Aug 2015.}
...
\begin{itemregion}{\lbar{blue}Talks}
	...
	\begin{talk} {Mergeable Replicated Data Types}
		{May 2019} {Department Seminar} {Massachusetts Institute of Technology}
	\end{talk}

	\begin{talk} {Retrofitting a Concurrent GC onto OCaml}
		{Oct 2018}  {GLASS Seminar} {University of Glasgow}
  \end{talk}

	\begin{talk} {Concurrent System Programming with Effect Handlers}
    {Oct 2018}  {Department Seminar} {University of Sussex}
  \end{talk}

	\begin{talk} {State of Multicore OCaml}
    {Jun 2018}  {Multicore Meeting} {INRIA Gallium, Paris}
  \end{talk}

	\begin{talk} {Bounding Data Races in Space and Time}
		{Feb 2018}  {Department Seminar} {Computer Science and Engineering, IIT Madras}
  \end{talk}

	\begin{talk} {Tutorial: Concurrent Programming with Effect Handlers}
		{Sep 2017} {CUFP @ ICFP 2017} {Oxford, UK}
	\end{talk}
