...
\begin{region} {\lbar{purple}Journal Publications}{{J}1}{7}
...
\begin{region} {\lbar{purple}Conference Publications}{{C}1}{10}
...
\begin{region} {\lbar{purple}Workshop Publications}{{W}1}{14}
