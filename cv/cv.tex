...
\begin{nonumregion} {\lbar{orange}Experience}
	% \positionnodesc{Chief Technology Officer, OCaml Labs Consultancy Ltd.}{Aug 2016 -- present}
...
\begin{region} {\lbar{purple}Workshop Publications}{{W}1}{8}
...
\begin{itemregion}{\lbar{red}Teaching/Advising}
	...
	\begin{itemize}
		\service{Databases, Lent 2016--17.}
		\service{Concurrent and Distributed Systems, Lent 2016--17.}
		\service{Databases, Michaelmas 2016--17.}
		\service{Concurrent and Distributed Systems, Michaelmas 2016--17.}
	...
	\begin{itemize}
		\service{Nicolas Assouad, ENS Paris, Hardware Support for Composable Lock-free Transactions, Mar 2017 -- present.}
...
\begin{itemregion} {\lbar{blue}Service}
	...
	\service{Organizer for Darwin College Science Seminar Series, Oct 2015 -- present.}
\end{itemregion}
