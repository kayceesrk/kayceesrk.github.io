...
\begin{region} {\lbar{purple}Technical Reports and Drafts}{{T}1}{2}
	...
	\begin{publication}{http://kcsrk.info/papers/schedact_jfp15.pdf}
		...
		{Dec 2014}{KC Sivaramakrishnan, Tim Harris, Simon Marlow, Simon Peyton Jones}
		{Under consideration for Journal of Functional Programming (JFP)}
	\end{publication}
...
\begin{itemregion} {\lbar{blue}Professional Service}
	...
	\service{Artifact Evaluation Committee member: PLDI 2015.} \vspace{0.5ex}
...
\begin{itemregion} {\lbar{blue}Awards and Recognitions}
  \service{Research Fellow, Darwin College, Cambridge, 2015--2018.}
