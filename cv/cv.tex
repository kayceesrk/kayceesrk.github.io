...
\begin{itemregion} {\lbar{blue}Awards and Recognitions}
  \service{\href{https://www.sigplan.org/Awards/Software/}{SIGPLAN Programming Languages Software Award}, 2023.}
  \service{OCaml core maintainer, 2021 -- present.}
	...
	\service{Distinguished paper at PADL 2021.}
...
\begin{itemregion} {\lbar{blue}Grants}
  \service{PI, FP Launchpad: A Centre for Functional Systems Research and Education at IIT Madras, Jane Street, 2026 -- 2030, INR 23.42 Cr.}
  \service{Co-I, Cybersecurity Centre of Excellence, IIT Madras, 2023 -- 2026, INR 5,00,000.}
	\service{PI, Multicore Support for Tezos blockchain, Tezos Foundation, 2019 -- 2023, \pounds194,000.}
...
\begin{itemregion}{\lbar{red}Teaching}
  \service{Lecturer:}
	\begin{itemize}
			\service{Concurrent Programming, IIT Madras, Spring '26.}
			\service{Compiler Design, IIT Madras, Monsoon '22}
			\service{Programs and Proofs, IIT Madras, Spring '25, Spring '20, Spring '21.}
			\service{Paradigms of Programming, IIT Madras, Monsoon '19, Monsoon '20, Monsoon '25.}
	\end{itemize}
...
\begin{itemregion}{\lbar{red}Advising}
	...
	\begin{itemize}
      \service{Nitish Yadav, 2025 -- present}
      \service{Durwasa Chakraborty, 2025 -- present}
	...
	\begin{itemize}
			\service{Vishakh Desai, MS, 2025 -- present}
			\service{Sanjeev Reddy, MS, 2025 -- present}
			\service{Surendar M, MTech, 2025 -- present}
			\service{Sagar Biswas, MTech, 2025 -- present}
			\service{Deepali Ande, MS, 2020 -- 2023}
