...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node [rectangle, fill=grey, anchor=north, minimum width=\paperwidth, minimum
         height=4cm] (box) at (current page.north){};
  \node [anchor=center] (name) at (box) {%
    ...
    \begin{tabular*}{7.5in}{@{\extracolsep{\fill}}lr}
      ...
      Assistant Professor, CSE, IITM \& CTO, Tarides\\
			Chennai, India \\
      \href{mailto:kc@kcsrk.info}{kc@kcsrk.info} \\
    \end{tabular*}
  };
\end{tikzpicture}
\vspace{0.9in}
...
\item \hspace{1ex} \parbox{7.3in}{I build robust, secure and scalable systems
  using programming language technology.}
\end{nonumregion}
...
\begin{itemregion} {\lbar{blue}Awards and Recognitions}
  \service{\href{https://www.sigplan.org/Awards/Software/}{SIGPLAN Programming Languages Software Award} for OCaml, 2023.}
  \service{OCaml core maintainer, 2021 -- present.}
	\service{Invited keynote speaker at PaPoC 2026.}
	\service{Invited keynote speaker at SERI 2026.}
	\service{Invited keynote speaker at ICFP 2022.}
	\service{Invited keynote speaker at OCaml Workshop 2022.}
	\service{Distinguished Paper Award at PADL 2021.}
	\service{Distinguished Paper Award at ICFP 2020.}
	\service{Class of 1991 Award for Young Faculty in Computer Science and Engineering, IIT Madras, 2019.}
  \service{Research Fellowship, Royal Commission for the Exhibition of 1851, 2015--2018.}
  \service{Research Fellowship, Darwin College, Cambridge, 2015--2018.}
  \service{Maurice H. Halstead Memorial Award for outstanding research in Software Engineering, Purdue University, 2014.}
  \service{Best paper award at Many-core Architecture Research Symposium at RWTH-Aachen, 2012.}
  %\service{SIGPLAN PAC travel grant for PLDI 2012 and POPL 2014.}
  %\service{NSF travel grant for ICFP 2013.}
\end{itemregion}

\begin{itemregion} {\lbar{blue}Invited Seminars and Workshops}
  \service{Observer, WG 2.1, Viana do Castelo, Sep 2025}
  \service{Dagstuhl Seminar 25241: ``Utilising and Scaling the WebAssembly Semantics'', Jun 2025}
  \service{Guest, WG 2.8, Maine, May 2025}
  \service{Observer, WG 2.1, Canberra, Nov 2024}
  \service{Guest, WG 2.8, Utrecht, Apr 2024}
	\service{Dagstuhl Seminar 23101: ``Foundations of WebAssembly'', Mar 2023}
	\service{Dagstuhl Seminar 21292: ``Scalable Handling of Effects'', Jul 2021}
	\service{Dagstuhl Seminar 16112: ``From Theory to Practice of Algebraic Effects and Handlers'', May 2016}
\end{itemregion}

% IIT Madras project dates, amounts and roles follow the academic profile,
% sections/07-projects.tex (Tula records retrieved 21 July 2026).
\begin{itemregion} {\lbar{blue}Grants}
  \service{PI, FP Launchpad: Centre for Functional Programming Research and Education at IIT Madras, Jane Street, 2025 -- 2029, INR 23.42 Cr.}
  \service{Co-I, Cybersecurity Centre of Excellence, IIT Madras, 2023 -- 2026, INR 5 Cr.}
  \service{PI / Co-PI, Multicore Support for Tezos Blockchain, Tezos Foundation, 2019 -- 2027, approximately INR 2.51 Cr.}
	\service{PI, Qilin: Scalable Concurrent Unikernels with Effect Handlers, IIT Madras, 2019 -- 2021, INR 500,000.}
	\service{Co-I, Feasibility of an Operating System for Interspatial Networking in a Built Environment, Centre for Digital Built Britain (CDBB), 2018, \pounds24,000.}
  \service{PI, Quelea: Safe Declarative Programming over Heterogeneous Parallel Systems, Royal Commission for the Exhibition of 1851, 2015--2018, \pounds102,000.}
\end{itemregion}

\begin{itemregion} {\lbar{blue}Academic Service}
	\service{\textbf{Organizer}, First FSTTCS Mentoring Workshop, 2025.}
	\service{\textbf{Organizer}, \href{https://ocamlretreat.org/}{First OCaml Retreat at Auroville}, 2024.}
  ...
  \service{\textbf{Associate Editor}, OOPSLA 2025.}
  \service{\textbf{Diversity Co-Chair}, ICFP/OOPSLA 2025 Organising Committee.}
  ...
  \service{\textbf{Steering Committee}: \href{https://www.icfpconference.org/structure.html}{Member-at-large and Diversity Co-Chair, ICFP}, 2023 -- 2027; PaPoC; ML Workshop, 2019 -- 2022.}
  \service{\textbf{SIGPLAN CARES committee member}, 2025 -- present.}
	\service{\textbf{Program Committee Chair}: PROPL 2025, PaPoC 2022, ML Workshop 2019.}
	\service{\textbf{Artifact Evaluation Committee Chair}: ESOP 2022.}
  \service{\textbf{Program Committee member}: ISEC 2027, SSS 2026, Haskell 2026, IICT 2026, ICFP 2025, PaPoC 2025, FunArch
  2025, APLAS 2025, OOPSLA 2024, PaPoC 2024, PEPM 2024, TFP 2024, POPL 2024,
  PLDI 2023, ML Workshop 2022, OCaml Workshop 2022, PLDI 2022, PEPM 2022, TyDe
  2021, GPCE 2021, PADL 2021, PaPoC 2021, ICFP 2020, PAPOC@EuroSys 2020, OCaml
  Workshop 2019, PMLDC@ECOOP 2017, Off-the-beaten track (OBT) 2017, OCaml
  Workshop 2016, SPLASH-MARC symposium, 2013.}
	\service{\textbf{Artifact Evaluation Committee member}: ICFP 2018, PLDI 2015, PPoPP/CGO 2016.} \vspace{0.5ex}
  \service{\textbf{Expert Reviewer}: TPDS 2025, TACO 2025, JFP 2024, POPL 2023,
  JFP 2021, PLDI 2020, ESOP 2020, JPDC 2020, LICS 2019, ECOOP 2019, TODS 2019,
  JFP 2018, POPL 2014, ICFP 2013, ASPLOS 2013, TLDI 2013, Concurrency and
  Computation: Practice and Experience 2013, Software: Practice and Experience
  2012.}
	\service{\textbf{External Review Committee member}: ICFP 2019.}
\end{itemregion}

\begin{itemregion} {\lbar{blue}Institutional Service}
  \service{Founder and Head, FP Launchpad, Centre for Functional Programming Research and Education, IIT Madras, Jan 2026 -- present.}
	\service{Technical Committee Member, Department of School Education, Government of Tamil Nadu, 2020 -- 2022.}
	\service{Board Member, Industrial Consultancy and Sponsored Research (ICSR), IIT Madras, 2021 -- 2023.}
...
\begin{region} {\lbar{purple}Edited Publications}{{E}1}{3}

	\begin{publication}{https://dl.acm.org/doi/pdf/10.1145/3759536}
		{Proceedings of the 2nd ACM SIGPLAN International Workshop on Programming for the Planet (PROPL)}
		{Oct 2025} {Anil Madhavapeddy, Dominic Orchard, KC Sivaramakrishnan (eds.)}
		{ACM SIGPLAN}
	\end{publication}
...
\begin{region} {\lbar{purple}Journal Publications}{{J}1}{10}
  ...
  \begin{publication}{https://kcsrk.info/papers/verifiedgc_feb_25.pdf}
    ...
    {Mar 2025}{Sheera Shamsu, Dipesh Kafle, Dhruv Maroo, Kartik Nagar, Karthikeyan Bhargavan, KC Sivaramakrishnan}
		{Journal of Automated Reasoning (JAR), 2025}
	\end{publication}
  ...
  \begin{publication}{http://kcsrk.info/papers/sting_scp13.pdf}{Efficient Sessions}
...
\begin{region} {\lbar{purple}Conference Publications}{{C}1}{18}

	\begin{publication} {https://kcsrk.info/papers/fides_asiaccs_2026.pdf}
		{FIDES: End-to-end Compartments for Mixed-language Systems}
		{Jun 2026} {Sai Venkata Krishnan, Arjun Menon, Chester Rebeiro, KC Sivaramakrishnan}
...
\begin{region} {\lbar{purple}Workshop Publications}{{W}1}{26}

	\begin{publication}{https://kcsrk.info/papers/sal_jan26.pdf}
		{Sal: Multi-modal Verification of Replicated Data Types}
		{Apr 2026}{Pranav Ramesh, Vimala Soundarapandian, KC Sivaramakrishnan}
		{Workshop on Principles and Practice of Consistency for Distributed Data (PaPoC), 2026}
	\end{publication}

	\begin{publication}{https://kcsrk.info/papers/ocaml_oct25.pdf}
		{A Mechanically Verified Garbage Collector for OCaml}
		{Oct 2025}{Sheera Shamsu, Dipesh Kafle, Dhruv Maroo, Kartik Nagar, Karthikeyan Bhargavan, KC Sivaramakrishnan}
		{OCaml Workshop, 2025}
	\end{publication}
  ...
  \begin{publication}{https://kcsrk.info/papers/kcas_ocaml23b.pdf}
	...
	\begin{publication}{https://kcsrk.info/papers/multicore-ocaml20.pdf}
		{Parallelising your OCaml Code with Multicore OCaml}
		{Aug 2020}{Sadiq Jaffer, Sudha Parimala, KC Sivaramakrishnan, Tom Kelly, Anil Madhavapeddy}
		{OCaml Workshop, 2020}
	\end{publication}
...
\begin{itemregion}{\lbar{red}Teaching}
  \service{Lecturer:}
  \begin{itemize}
    \service{\href{https://onlinecourses.nptel.ac.in/e-learning/preview/noc26_cs90}{Functional Programming with OCaml}, NPTEL MOOC, 2026. Twelve modules of recorded lectures with an interactive course book.}
			\service{CS6868 Concurrent Programming, IIT Madras, Spring '26.}
			\service{CS3300 Compiler Design, IIT Madras, Monsoon '22, Monsoon '26.}
			\service{CS6225 Programs and Proofs, IIT Madras, Spring '20, Spring '21, Spring '25. Introduced the course in the department.}
			\service{CS3100 Paradigms of Programming, IIT Madras, Monsoon '19, Monsoon '20, Monsoon '25.}
	\end{itemize}
  \service{\href{https://en.wikipedia.org/wiki/Tutorial_system}{Supervisions} at University of Cambridge:}
  \begin{itemize}
...
\begin{itemregion}{\lbar{red}Advising}
	...
	\begin{itemize}
      \service{Nitish Yadav, 2025 -- present. Model checking of replicated data types. Co-guide with Kartik Nagar, IIT Madras.}
      \service{Durwasa Chakraborty, 2025 -- present. Verifiable lock-free software transactional memory. Primary guide.}
			\service{Sai Venkata Krishnan, 2021 -- present. Secure hardware-software co-design. Co-guide with Chester Rebeiro, IIT Madras.}
			\service{Sheera Shamsu, 2019 -- 2026 (completed). Thesis: \emph{A Mechanically Verified Garbage Collector for OCaml}. Primary guide; co-guide Kartik Nagar, IIT Madras.}
    \service{Vimala Soundarapandian, 2020 -- 2026 (completed). Thesis: \emph{Pragmatic Verification of Replicated Data Types}. Co-guide with Kartik Nagar, IIT Madras.}
	\end{itemize}

	\service{Master's Students}
	\begin{itemize}
			\service{Vishakh Desai, MS, 2025 -- present. Election security. Primary guide; co-guide Aishwarya Thiruvengadam, IIT Madras.}
			\service{B Sanjeev Reddy, MS, 2025 -- present. MMTk-based memory management for OCaml. Guide.}
			\service{Surendar M, MTech, 2025 -- present}
			\service{Sagar Biswas, MTech, 2025 -- present}
			\service{Deepali Ande, MS, 2020 -- 2023. Thesis: \emph{Composing Schedulers using Effect Handlers}. Guide.}
			\service{Sumit Padhiyar, MS, 2019 -- 2021. Thesis: \emph{Coverage-guided Property Fuzzing for Event-driven and Parallel Programs}. Guide.}
			\service{Shashank Shekhar Dubey, MS, 2019 -- 2021. Thesis: \emph{Banyan: Coordination-free Distributed Transactions over Mergeable Types}. Guide.}
			\service{Atul Dhiman, MTech, 2019 -- 2020}
	\end{itemize}

	\service{Undergraduate Students}
	\begin{itemize}
      \service{Md. Isfarul Haque, BTP, 2026}
      \service{Pranav Ramesh, BTP, 2026}
      \service{Aadi Srivastava, UGRC, 2026}
      \service{Aditya Srivastava, UGRC, 2025}
      \service{Aditya Palwe, UGRC, 2025}
      \service{Raadhes Chandrulu, UGRC, 2025}
      \service{Athish Pranav, UGRC, 2024}
      \service{Sooraj Srinivasan, UGRC, 2023}
      \service{Mantra Trambadia, UGRC, 2023}
      \service{Narasimha, UGRC, 2023}
			\service{Anirudh Sunder Raj, Dual Degree Project, 2020 -- 2021}
	...
	\begin{itemize}
			\service{Alina Banerjee, IITM, 2025 -- present}
			\service{Navaneeth Nambiar, IITM, 2025 -- present}
